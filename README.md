...
## Построение ПКА:
На этой же структуре слова  *w* = *w1* *w2* *w3*, можем построить ПКА где из входящего состояния необходимо выполнение следующих условий:<br>
1. Слово начинается на (ab|bc|bbbb|bbb)*
2. Слово содержит bb(a|b)(a|b)
3. Слово кончается на (cac|accc|bca)*
то есть слово распознается автоматом если 1, 2 и 3 условие выполняется.
Вот сам ПКА:
<img width="1280" height="1002" alt="image" src="https://github.com/user-attachments/assets/b0498322-6431-4045-8ec3-527f1ad8c7a4" />

тут выбранное слово *w* подается в виде 3 конечных состояний *w* = *q0 k4 c0*,
т.е. слово должно разбиваться на 3 состояния, и потом каждое конъюнкцией проверяется достижение каждой выбранной части до соответствующего  ей конечного состояния .
