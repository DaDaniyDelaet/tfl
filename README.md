...
И всё-таки, чтобы попытаться избежать подобного противоречия и всё-таки построить терминирующую и конфлюэнтную T`, для нашей системы изменим и добавим правила, чтобы попытаться сохранить классы эквивалентности (они были описаны выше вместе с автоматом).<br>
...
тогда у нас в силу того, что правый редекс длиннее левого, выполняется терминация, а для конфлюэнтности достаточно локальной конфлюэнтности: в T` нет двух правил с одинаковой левой частью, и левые части не перекрываются так, чтобы давать разные необратимые продолжения. любое потенциальное перекрытие либо редуцируется однозначно, либо приводит к одному и тому же сокращённому слову, поскольку после применения любого правила остаётся строка, в которой больше нет областей для альтернативных редукций. таким образом, локальной конфлюэнтности достаточно, а из терминации и локальной конфлюэнтности по лемме Ньюмана следует глобальная конфлюэнтность.
