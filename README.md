...
E, c, b, a, cc, ca, (ab)<sup>n</sup>, b(ab)<sup>n</sup>, a(ba)<sup>n</sup>, (ba)<sup>n</sup>, сa(ba)<sup>n</sup>, с(ab)<sup>n</sup>
...
cccc → a<br>
cccccc → a<br>
и т.д., снова алгоритм не выполним.<br>

из 1 и 2 => к нашей системе алгоритм не применим (подобный пример был в лекциях про Eq(x, x) → True и Eq(x, x+1) → False, к которой алгоритм не применим).<br>
