...
### пополняемость по Кнуту–Бендиксу для неизмененынной системы 
Теперь разберем пополняемость по Кнуту–Бендиксу для системы без изменений правила и их сортировки :<br>
найти строгий инвариант (или порядок при котором убывает) не получилось, но тем не менее докажем что наша система не пополняема по этому алгоритму.<br>
...
### пополняемость по Кнуту–Бендиксу для измененынной системы 
